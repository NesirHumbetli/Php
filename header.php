...
<head>
	<base href="http://localhost/CV-PDO/">
	<!-- Basic -->
	<meta charset="utf-8">
				...
				<div class="header-container header-nav header-nav-bar header-nav-bar-primary">
					<div class="container">
						...
						<div class="header-search visible-lg">
							<form id="searchForm" action="axtar" method="POST">
								<div class="input-group">
									<input type="text" class="form-control" name="axtarilan" id="q" placeholder="Axtar..." required>
									<span class="input-group-btn">
										<button class="btn btn-default" name="axtaran" type="submit"><i class="icon-magnifier icons"></i></button>
									</span>
								</div>
							</form>
						</div>
