<footer class="short" id="footer">
					...
					<div class="row">
						<div class="col-md-5">
							<a href="demo-law-firm.html" class="logo mb-md">
								<img alt="Porto Website Template" class="img-responsive" width="97" height="32" src="<?php echo $ayarcek['ayar_altlogo']; ?>">
							</a>
							<p><?php echo $ayarcek['ayar_description']; ?></p>
						</div>
						<div class="col-md-3 col-md-offset-1">
							<h5 class="mb-sm" style="font-family: arial">Ünvan Məlumatları</h5>
							<ul class="list list-icons mt-xl">
								<li><i class="fa fa-map-marker"></i> <strong>Ünvan:</strong> <?php echo $ayarcek['ayar_adres']; ?><br><?php echo $ayarcek['ayar_ray']; ?> / <?php echo $ayarcek['ayar_sehr']; ?></li>
								<li><i class="fa fa-envelope"></i> <strong>Email:</strong> <a href="mailto:<?php echo $ayarcek['ayar_mail']; ?>"><?php echo $ayarcek['ayar_mail'] ?></a></li>
							</ul>
						</div>
						<div class="col-md-3">
							<h5 class="mb-sm" style="font-family: arial;">Bizimlə Əlaqə</h5>
				...
				<div class="footer-copyright">
					<div class="container">
						<div class="row">
							<div class="col-md-12">
								<p>© Copyright 2020. All Rights Reserved. | <a href="https://crazyphp.000webhostapp.com" target="_blank"><?php echo $ayarcek['ayar_author']; ?></a></p>
							</div>
						</div>
					</div>
				</div>
